...
def build_blue_reasoner_from_env() -> BlueReasoner:
    ...
    mode = os.getenv("BLUE_AGENT_REASONER", "auto").strip().lower()
    ...
    timeout = float(os.getenv("OLLAMA_TIMEOUT_SECONDS", str(DEFAULT_OLLAMA_TIMEOUT_SECONDS)))
    think = os.getenv("OLLAMA_THINK", str(DEFAULT_OLLAMA_THINK)).strip().lower() == "true"
